...
int main()
{
    ...
    cout<<"Press 1 to insert element to the Binary Tree"<<endl;
    cout<<"Press 2 to delete element from the Binary Tree"<<endl;
    cout<<"Press 0 for preorder, inorder and postorder traversals of the Binary Tree"<<endl;
    ...
    {   
        ...
        switch(x)
        {
            ...
            case 2: cin>>y;
                    ...
                    break;
            case 0: cout<<"Preorder Traversal"<<endl;
