...
class Parent
{
    ...
    public void display()
    {
        System.out.println("This function is adding and substracting two numbers");
...
class Child extends Parent
{
    ...
    public void display()
    {
        System.out.println("This function is adding, substracting, multiplying and dividing two numbers");
